...
Widget buildSecondCard(HomeController controller) {
  return controller.dataSummaryDashboard != {}
      ? Padding(
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    index == 0
                                                        ? Text(
                                                            (controller.dataSummaryDashboard['capitalAmountPlan'] ?? 0)
                                                                .toString()
                                                                .replaceAllMapped(
                                                                    reg, mathFunc),
                                                            style: const TextStyle(
                                                                ...
                                                                fontSize: 14))
                                                        : Text(
                                                            (controller.dataSummaryDashboard['capitalAmount'] ?? 0)
                                                                .toString()
                                                                .replaceAllMapped(
                                                                    reg,
                                                                    mathFunc),
